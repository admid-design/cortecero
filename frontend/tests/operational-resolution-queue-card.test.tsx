...
test("renders empty state and filter controls", () => {
  ...
  assert.match(html, /Operational Resolution Queue/);
  assert.match(html, /Sin items de resolución para los filtros actuales\./);
...
test("preserves backend order without frontend re-sorting", () => {
  const orderedItems: OperationalResolutionQueueItem[] = [
    {
